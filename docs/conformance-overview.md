...
| iGrant.io       | Wallet            | ✅      | Full conformance                                   | Organisation Wallet Suite<br> [iGrant.io in Wallet Capability Viewer](https://webuild-consortium.github.io/wp4-wallets-group/?id=52)<br> [Organisation Wallet Suite by iGrant.io](https://docs.igrant.io/docs/organisation-wallet-overview/) |
