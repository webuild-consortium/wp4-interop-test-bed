...
| Cleverbase    | Personal Wallet         | ✅       | Full conformance                                 | [Cleverbase in Wallet Capability Viewer](https://webuild-consortium.github.io/wp4-wallets-group/?id=18)                                                                                                                                                                                                            |
...
| GUnet        | GUnet (wwWallet)              | ✅       | Full conformance, except for support for DID:web | [GUnet in Wallet Capability Viewer](https://webuild-consortium.github.io/wp4-wallets-group/?id=35)                                                                                                        |
| IDUnion      | Business Wallet           | ✅       | Full conformance                        |                                                                                                                                                                                                            |
| iGrant.io    | Organisation Wallet Suite | ✅       | Full conformance                                 | [iGrant.io in Wallet Capability Viewer](https://webuild-consortium.github.io/wp4-wallets-group/?id=52) [Organisation Wallet Suite by iGrant.io](https://docs.igrant.io/docs/organisation-wallet-overview/) |
...
| KVK        | KVK NL Wallet              | ✅       | Full conformance, except for support for DID:web | [NL Wallet by KVK](https://wallet-connect.eu/?mode=personal&lang=en)     
