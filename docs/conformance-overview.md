...
| ------------ | --------------------------------------------------------------------------------------------------- | ------- | ------------------------------------------------ | ------------------------------------------------------------------------------------------------------ |
| iGrant.io    | Organisational Wallet Suite | ✅       | Full conformance                                 | [iGrant.io in Wallet Capability Viewer](https://webuild-consortium.github.io/wp4-wallets-group/?id=52) [Organisation Wallet Suite by iGrant.io](https://docs.igrant.io/docs/organisation-wallet-overview/)|
...
| DigitelTS  | Issuer / Verifier | ✅       | Full conformance | |
